...
export function Table(props: TableProps) {
	return (
		<table
			{...props}
			className={twMerge('w-full text-sm border-t-2 border-b-2 border-zinc-800', props.className)}
		/>
	)
}
...
export function TableHead(props: TableHeadProps) {
	return (
		<th
			{...props}
			className={twMerge('text-left py-3 px-4 font-medium text-zinc-300', props.className)}
		/>
	)
}
...
export function TableBody(props: TableBodyProps) {
	return (
		<tbody
			{...props}
			className={twMerge('[&_tr:last-child]:border-0 [&_tr:hover]:bg-zinc-800/50', props.className)}
		/>
	)
}
